...
def main():
    ...
    run(*common_flags, '-framework','AppKit','-framework','Network','-framework','JavaScriptCore','-framework','Security',ROOT/'macos/RuntimePaths.swift',ROOT/'macos/InputAuthorization.swift',ROOT/'macos/AmbientDesignPreview.swift',ROOT/'macos/InputMonitorState.swift',ROOT/'macos/AmbientCatalog.swift',ROOT/'macos/AmbientLighting.swift',ROOT/'macos/AmbientLibrary.swift', ROOT/'macos/MenuBar.swift', ROOT/'macos/LightingDiagram.swift', ROOT/'macos/WindowPresentation.swift', ROOT/'macos/StickyPresentation.swift', ROOT/'macos/StickyWindowSupport.swift', ROOT/'macos/StickyDashboard.swift', ROOT/'macos/PresetPagination.swift', ROOT/'macos/PulseConfiguration.swift', ROOT/'macos/WorkbenchState.swift', ROOT/'macos/WorkbenchViews.swift', ROOT/'macos/App.swift', '-o', app/'Contents/MacOS/CodexPulse')
